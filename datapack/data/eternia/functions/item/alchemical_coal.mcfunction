...
## If Smither
# Apply Saturation
execute if entity @s[tag=eternia.class.smither] run effect give @s minecraft:saturation 1 2 true
## If Not Smither
# Apply Poison
execute unless entity @s[tag=eternia.class.smither] run effect give @s minecraft:poison 30 1 false
